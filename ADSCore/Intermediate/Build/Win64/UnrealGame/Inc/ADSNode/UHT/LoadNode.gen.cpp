...
#include "D:/Unreal Projects/ADSCoreLite/PluginBuild/ADSCore/HostProject/Plugins/ADSCore/Source/ADSNode/Public/LoadNode.h"
...
void FADdownloadStatus_DelegateWrapper(const FMulticastScriptDelegate& ADdownloadStatus, int32 Status, const FString& errorMessage)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULoadNode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULoadNode_loadInterstitial, "loadInterstitial" }, // 2894333003
		{ &Z_Construct_UFunction_ULoadNode_OnAdDownloadFailure, "OnAdDownloadFailure" }, // 3950016841
		{ &Z_Construct_UFunction_ULoadNode_OnAdDownloadSuccess, "OnAdDownloadSuccess" }, // 282017618
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULoadNode_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_ADSCore_Source_ADSNode_Public_LoadNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULoadNode, ULoadNode::StaticClass, TEXT("ULoadNode"), &Z_Registration_Info_UClass_ULoadNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULoadNode), 1923137929U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_ADSCore_Source_ADSNode_Public_LoadNode_h_4122023987(TEXT("/Script/ADSNode"),
